    ...
    static var previews: some View {
        Group {
            HStack {
                ...
                VStack(alignment: .center, spacing: 20) {
                    SpaceAvatarImage(mxContentUri: nil, sdnItemId: name, displayName: name, size: .xSmall)
                    SpaceAvatarImage(mxContentUri: nil, sdnItemId: name, displayName: name, size: .medium)
                    SpaceAvatarImage(mxContentUri: nil, sdnItemId: name, displayName: name, size: .xLarge)
                }
            }
