...
final class OnboardingSplashScreenCoordinator: OnboardingSplashScreenCoordinatorProtocol {
    ...
    var videModeP:OnboardingSplashScreenViewModel
    // MARK: - Setup
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(handleNotification(_:)), name: NSNotification.Name("MyNotificationNameLoginSuccess"), object: nil)

    }
    
    @objc func handleNotification(_ notification: Notification) {
        let res: OnboardingSplashScreenViewModelResult = .login
        self.completion?(res)
      }
