...
enum UserAgentParser {
    private enum Constants {
        ...
        static let androidKeyword = "; SDNAndroidSdk2"
    ...
    // Legacy:  Element/1.0.0 (Linux; U; Android 6.0.1; SM-A510F Build/MMB29; Flavour GPlay; SDNAndroidSdk2 1.0)
    // New:     Element dbg/1.5.0-dev (Xiaomi Mi 9T; Android 11; RKQ1.200826.002 test-keys; Flavour GooglePlay; SDNAndroidSdk2 1.5.0)
    ...
    // Legacy:  SendingnNetwork/1.8.21 (iPhone; iOS 15.2; Scale/3.00)
    // New:     SendingnNetwork/1.8.21 (iPhone X; iOS 15.2; Scale/3.00)
