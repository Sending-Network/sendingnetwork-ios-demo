...
final class ChangePasswordCoordinatorBridgePresenter: NSObject {
    ...
    func present(from viewController: UIViewController, animated: Bool) {
        let params = ChangePasswordCoordinatorParameters(restClient: session.sdnRestClient)
        ...
        let navController = SendingnNetworkNavigationController(rootViewController: presentable.toPresentable())
