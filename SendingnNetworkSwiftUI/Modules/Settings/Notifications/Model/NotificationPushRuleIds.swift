...
enum NotificationPushRuleId: String {
    ...
    case msc3930pollStart = ".org.sdn.msc3930.rule.poll_start"
    // poll started event (one to one)
    case oneToOnePollStart = ".m.rule.poll_start_one_to_one"
    case msc3930oneToOnePollStart = ".org.sdn.msc3930.rule.poll_start_one_to_one"
    // poll ended event
    case pollEnd = ".m.rule.poll_end"
    case msc3930pollEnd = ".org.sdn.msc3930.rule.poll_end"
    // poll ended event (one to one)
    case oneToOnePollEnd = ".m.rule.poll_end_one_to_one"
    case msc3930oneToOnePollEnd = ".org.sdn.msc3930.rule.poll_end_one_to_one"
}
