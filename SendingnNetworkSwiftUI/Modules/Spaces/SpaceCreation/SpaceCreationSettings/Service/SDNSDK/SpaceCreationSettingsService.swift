...
class SpaceCreationSettingsService: SpaceCreationSettingsServiceProtocol {
    ...
    init(roomName: String, userDefinedAddress: String?, session: MXSession) {
        ...
        avatarViewDataSubject = CurrentValueSubject(AvatarInput(mxContentUri: userDefinedAddress, sdnItemId: "", displayName: roomName))
    ...
    private func updateAvatar() {
        avatarViewDataSubject.send(AvatarInput(mxContentUri: currentAddress, sdnItemId: "", displayName: roomName))
    }
