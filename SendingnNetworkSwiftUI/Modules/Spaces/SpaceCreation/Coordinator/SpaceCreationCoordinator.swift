...
final class SpaceCreationCoordinator: Coordinator {
    ...
    private func createPeopleChooserCoordinator() -> SDNItemChooserCoordinator {
        let parameters = SDNItemChooserCoordinatorParameters(
            session: parameters.session,
            ...
            viewProvider: SpaceCreationSDNItemChooserViewProvider(),
            itemsProcessor: SpaceCreationInviteUsersItemsProcessor(creationParams: parameters.creationParameters)
        )
        let coordinator = SDNItemChooserCoordinator(parameters: parameters)
    ...
    private func createRoomChooserCoordinator() -> SDNItemChooserCoordinator {
        let parameters = SDNItemChooserCoordinatorParameters(
            session: parameters.session,
