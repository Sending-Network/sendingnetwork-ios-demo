...
class SpaceCreationAddRoomsItemsProcessor: SDNItemChooserProcessorProtocol {
    // MARK: Private
    ...
    private(set) var dataSource: SDNItemChooserDataSource = SDNItemChooserRoomsDataSource()
