...
struct SpaceCreationPostProcess: View {
    ...
    private var avatarView: some View {
        ZStack {
            SpaceAvatarImage(mxContentUri: viewModel.viewState.avatar.mxContentUri, sdnItemId: viewModel.viewState.avatar.sdnItemId, displayName: viewModel.viewState.avatar.displayName, size: .xLarge)
                .padding(6)
