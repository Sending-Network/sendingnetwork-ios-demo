...
struct CompletionSuggestionList: View {
    ...
    var body: some View {
        if viewModel.viewState.items.isEmpty {
            ...
            ZStack {
                CompletionSuggestionListItem(content: CompletionSuggestionViewStateItem.user(id: "Prototype", avatar: AvatarInput(mxContentUri: "", sdnItemId: "", displayName: "Prototype"), displayName: "Prototype"))
