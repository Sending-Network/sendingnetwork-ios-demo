...
final class RoomAccessCoordinator: Coordinator {
    ...
    private func createRestrictedAccessSpaceChooserCoordinator(with roomId: String) -> SDNItemChooserCoordinator {
        let paramaters = SDNItemChooserCoordinatorParameters(
