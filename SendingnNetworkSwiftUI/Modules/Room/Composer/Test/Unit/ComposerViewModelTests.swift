...
final class ComposerViewModelTests: XCTestCase {
    ...
    func testLinkAction() {
        ...
        context.send(viewAction: .linkTapped(linkAction: .edit(url: "https://sendingnetwork.io")))
        XCTAssertEqual(result, .linkTapped(LinkAction: .edit(url: "https://sendingnetwork.io")))
    }
}
