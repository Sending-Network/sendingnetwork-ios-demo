...
final class ComposerLinkActionUITests: MockScreenTestCase {
    func testCreate() {
        ...
        linkTextField.tap()
        linkTextField.clearAndTypeText("sendingnetwork.io")
    ...
    func testCreateWithText() {
        ...
        XCTAssertTrue(linkTextField.exists)
        linkTextField.tap()
        linkTextField.typeText("sendingnetwork.io")
        XCTAssertFalse(saveButton.isEnabled)
        textTextField.tap()
    ...
    func testEdit() {
        ...
        XCTAssertEqual(value, "https://sendingnetwork.io")
        linkTextField.clearAndTypeText("")
        XCTAssertFalse(saveButton.isEnabled)
        linkTextField.clearAndTypeText("sdn.org")
        XCTAssertTrue(saveButton.isEnabled)
    }
}
