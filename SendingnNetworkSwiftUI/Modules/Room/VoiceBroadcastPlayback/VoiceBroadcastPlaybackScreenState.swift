...
enum MockVoiceBroadcastPlaybackScreenState: MockScreenState, CaseIterable {
    ...
    var screenView: ([Any], AnyView) {
        ...
        let details = VoiceBroadcastPlaybackDetails(senderDisplayName: "Alice", avatarData: AvatarInput(mxContentUri: "", sdnItemId: "!fakeroomid:sdn.org", displayName: "The name of the room"))
