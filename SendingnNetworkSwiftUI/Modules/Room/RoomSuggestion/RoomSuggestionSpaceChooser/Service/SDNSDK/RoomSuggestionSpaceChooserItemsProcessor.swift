...
class RoomSuggestionSpaceChooserItemsProcessor: SDNItemChooserProcessorProtocol {
    // MARK: Private
    ...
    init(roomId: String, session: MXSession) {
        ...
        dataSource = SDNItemChooserRoomDirectParentsDataSource(roomId: roomId, preselectionMode: .suggestedRoom)
    }
