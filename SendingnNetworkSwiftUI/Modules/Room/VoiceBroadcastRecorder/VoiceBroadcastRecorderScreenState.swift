...
enum MockVoiceBroadcastRecorderScreenState: MockScreenState, CaseIterable {
    ...
    var screenView: ([Any], AnyView) {
        let details = VoiceBroadcastRecorderDetails(senderDisplayName: "", avatarData: AvatarInput(mxContentUri: "", sdnItemId: "!fakeroomid:sdn.org", displayName: "The name of the room"))
