...
struct AuthenticationRecaptchaWebView: UIViewRepresentable {
    ...
    let siteKey: String
    /// The node's URL, used so ReCaptcha can validate where the request is coming from.
    let nodeURL: URL
    ...
    func updateUIView(_ webView: WKWebView, context: Context) {
        ...
        webView.loadHTMLString(context.coordinator.htmlString(with: siteKey, using: recaptchaTheme), baseURL: nodeURL)
    }
