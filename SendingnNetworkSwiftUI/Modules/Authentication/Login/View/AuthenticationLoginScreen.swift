...
//                    .padding(.bottom, 22)
//
//                if viewModel.viewState.node.showLoginForm {
//                    loginForm
//                }
//
//                if viewModel.viewState.node.showQRLogin {
//                    qrLoginButton
//                }
//
//                if viewModel.viewState.node.showLoginForm, viewModel.viewState.showSSOButtons {
//                    Text(VectorL10n.or)
...
//    }
    ...
    var serverInfo: some View {
        AuthenticationServerInfoSection(address: viewModel.viewState.node.address,
                                        flow: .login) {
    ...
    var ssoButtons: some View {
        VStack(spacing: 16) {
            ForEach(viewModel.viewState.node.ssoIdentityProviders) { provider in
    ...
    /// Parses the username for a node.
    ...
    func loginClick() {
        viewModel.send(viewAction: .loginClick)
    }
}
