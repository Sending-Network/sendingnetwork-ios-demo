...
class AuthenticationLoginViewModelTests: XCTestCase {
    ...
    @MainActor override func setUp() async throws {
        viewModel = AuthenticationLoginViewModel(node: defaultNode)
    ...
    @MainActor func testFallbackServer() {
        ...
        // Then the view state should be updated with the node and hide the SSO buttons and login form.
        XCTAssertFalse(context.viewState.showSSOButtons, "The SSO buttons should not be shown.")
        XCTAssertFalse(context.viewState.node.showLoginForm, "The login form should not be shown.")
    }
}
