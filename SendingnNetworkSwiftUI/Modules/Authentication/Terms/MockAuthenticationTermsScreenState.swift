...
enum MockAuthenticationTermsScreenState: MockScreenState, CaseIterable {
    ...
    var screenView: ([Any], AnyView) {
        ...
        switch self {
        case .sdnDotOrg:
            viewModel = AuthenticationTermsViewModel(node: .mockSDNDotOrg,
                                                     policies: [AuthenticationTermsPolicy(url: "https://sdn-client.sdn.org/_api/consent?v=1.0",
        ...
        case .accepted:
            viewModel = AuthenticationTermsViewModel(node: .mockSDNDotOrg,
                                                     policies: [AuthenticationTermsPolicy(url: "https://sdn-client.sdn.org/_api/consent?v=1.0",
                                                                                          ...
                                                                                          accepted: true)])
        case .multiple:
            viewModel = AuthenticationTermsViewModel(node: .mockBasicServer, policies: [
