...
/// Set of methods to be able to login to an existing account on a node.
///
/// More documentation can be found in the file https://github.com/Sending-Network/element-android/blob/main/docs/signin.md
class LoginWizard {
    struct State {
    ...
    /// Ask the node to reset the user password. The password will not be
