...
struct AuthenticationSoftLogoutScreen: View {
    ...
    var header: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text(VectorL10n.authSoftlogoutReason(viewModel.viewState.credentials.nodeName, viewModel.viewState.credentials.userDisplayName, viewModel.viewState.credentials.userId))
