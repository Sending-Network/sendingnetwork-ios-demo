...
enum MockAuthenticationServerSelectionScreenState: MockScreenState, CaseIterable {
    ...
    var screenView: ([Any], AnyView) {
        ...
        switch self {
        case .sdn:
            viewModel = AuthenticationServerSelectionViewModel(nodeAddress: "sdn.org",
                                                               flow: .register,
                                                               hasModalPresentation: true)
        case .emptyAddress:
            viewModel = AuthenticationServerSelectionViewModel(nodeAddress: "",
                                                               flow: .register,
                                                               hasModalPresentation: true)
        case .invalidAddress:
            viewModel = AuthenticationServerSelectionViewModel(nodeAddress: "thisisbad",
                                                               flow: .register,
                                                               hasModalPresentation: true)
