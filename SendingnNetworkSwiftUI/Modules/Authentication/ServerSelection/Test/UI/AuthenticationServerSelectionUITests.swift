...
class AuthenticationServerSelectionUITests: MockScreenTestCase {
    func testRegisterState() {
        app.goToScreenWithIdentifier(MockAuthenticationServerSelectionScreenState.sdn.title)
        ...
        XCTAssertEqual(serverTextField.value as? String, "sdn.org", "The server shown should be sdn.org as passed to the view model init.")
