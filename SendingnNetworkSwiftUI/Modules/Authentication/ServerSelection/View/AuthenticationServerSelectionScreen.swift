...
struct AuthenticationServerSelectionScreen: View {
    ...
    var textField: some View {
        TextField(VectorL10n.authenticationServerSelectionServerUrl, text: $viewModel.nodeAddress) {
        ...
        .onChange(of: viewModel.nodeAddress) { _ in viewModel.send(viewAction: .clearFooterError) }
