...
class MockLiveLocationSharingViewerService: LiveLocationSharingViewerServiceProtocol {
    ...
    private func createFirstUserLiveLocation() -> UserLiveLocation {
        let userAvatarData = AvatarInput(mxContentUri: nil, sdnItemId: "@alice:sdn.org", displayName: "Alice")
    ...
    private func createSecondUserLiveLocation() -> UserLiveLocation {
        let userAvatarData = AvatarInput(mxContentUri: nil, sdnItemId: "@bob:sdn.org", displayName: "Bob")
    ...
    private func createRandomUserLiveLocation() -> UserLiveLocation {
        ...
        let userAvatarData = AvatarInput(mxContentUri: nil, sdnItemId: "@user_\(uuidString):sdn.org", displayName: "User \(uuidString)")
