...
class MockTemplateRoomListService: TemplateRoomListServiceProtocol {
    static let mockRooms = [
        TemplateRoomListRoom(id: "!aaabaa:sdn.org", avatar: MockAvatarInput.example, displayName: "SDN Discussion"),
        TemplateRoomListRoom(id: "!zzasds:sdn.org", avatar: MockAvatarInput.example, displayName: "Element Mobile"),
        TemplateRoomListRoom(id: "!scthve:sdn.org", avatar: MockAvatarInput.example, displayName: "Alice Personal")
    ]
