...
- (void)setUp
{
    ...
    eventFormatter = [[MXKEventFormatter alloc] initWithSDNSession:nil];

    eventFormatter.treatSDNUserIdAsLink = YES;
    eventFormatter.treatSDNRoomIdAsLink = YES;
    eventFormatter.treatSDNRoomAliasAsLink = YES;
    eventFormatter.treatSDNEventIdAsLink = YES;
...
- (void)testRenderHTMLStringWithLink
{
    ...
    NSString *html = @"This text contains a <a href=\"https://www.sdn.org/\">link</a>.";
    ...
    [attributedString enumerateAttribute:NSLinkAttributeName
        ...
        if ([value isKindOfClass:NSURL.class])
        {
            ...
            XCTAssertEqualObjects(url, [NSURL URLWithString:@"https://www.sdn.org/"], @"href links should be included in the text.");
            didFindLink = YES;
        }
    }];
...
- (void)testRenderHTMLStringWithLinkInHeader
{
    ...
    NSString *h1HTML = @"<h1><a href=\"https://www.sdn.org/\">Matrix.org</a></h1>";
    NSString *h3HTML = @"<h3><a href=\"https://www.sdn.org/\">Matrix.org</a></h3>";
...
- (void)testRenderHTMLStringWithIFrame
{
    ...
    NSString *html = @"<iframe src=\"https://www.sdn.org/\"></iframe>";
...
{
    // Given an HTML string representing a sdn reply.
    NSString *html = @"<mx-reply><blockquote><a href=\"https://sdn.to/#/someroom/someevent\">In reply to</a> <a href=\"https://sdn.to/#/@alice:sdn.org\">@alice:sdn.org</a><br>Original message.</blockquote></mx-reply>This is a reply.";
    ...
    XCTAssertEqualObjects(plainString, @"In reply to @alice:sdn.org\nOriginal message.\nThis is a reply.",
...
{
    // Given an HTML string representing a sdn reply where the original message has invalid HTML.
    NSString *html = @"<mx-reply><blockquote><a href=\"https://sdn.to/#/someroom/someevent\">In reply to</a> <a href=\"https://sdn.to/#/@alice:sdn.org\">@alice:sdn.org</a><br><h1>Heading with <badtag>invalid</badtag> content</h1></blockquote></mx-reply>This is a reply.";
...
- (void)testRenderHTMLStringWithImageHandler
{
    ...
    NSURL *imageURL = [NSURL URLWithString:@"https://sdn.org/images/sdn-logo.svg"];
...
{
    NSString *s = @"SDN HQ room is at #sdn:sdn.org.";
    NSAttributedString *as = [eventFormatter renderString:s forEvent:anEvent];

    NSRange linkRange = [s rangeOfString:@"#sdn:sdn.org"];
...
{
    NSString *s = @"SDN HQ room is at https://sdn.to/#/room/#sdn:sdn.org.";
    NSAttributedString *as = [eventFormatter renderString:s forEvent:anEvent];
...
- (void)testUserDisplayNameFromEventContent {
    MXEvent *event = [self eventFromJSON:@"{\"sender\":\"@alice:sdn.org\",\"content\":{\"displayname\":\"bob\",\"membership\":\"invite\"},\"origin_server_ts\":1616488993287,\"state_key\":\"@bob:sdn.org\",\"room_id\":\"!foofoofoofoofoofoo:sdn.org\",\"event_id\":\"$lGK3budX5w009ErtQwE9ZFhwyUUAV9DqEN5yb2fI4Do\",\"type\":\"m.room.member\",\"unsigned\":{}}"];
...
- (void)testUserDisplayNameFromNonMembershipEventContent {
    MXEvent *event = [self eventFromJSON:@"{\"sender\":\"@alice:sdn.org\",\"content\":{\"ciphertext\":\"foo\",\"sender_key\":\"bar\",\"device_id\":\"foobar\",\"algorithm\":\"m.megolm.v1.aes-sha2\"}},\"origin_server_ts\":1616488993287,\"state_key\":\"@bob:sdn.org\",\"room_id\":\"!foofoofoofoofoofoo:sdn.org\",\"event_id\":\"$lGK3budX5w009ErtQwE9ZFhwyUUAV9DqEN5yb2fI4Do\",\"type\":\"m.room.encrypted\",\"unsigned\":{}}"];
...
- (void)testUserAvatarUrlFromEventContent {
    MXEvent *event = [self eventFromJSON:@"{\"sender\":\"@alice:sdn.org\",\"content\":{\"displayname\":\"bob\",\"avatar_url\":\"mxc://foo.bar\",\"membership\":\"join\"},\"origin_server_ts\":1616488993287,\"state_key\":\"@bob:sdn.org\",\"room_id\":\"!foofoofoofoofoofoo:sdn.org\",\"event_id\":\"$lGK3budX5w009ErtQwE9ZFhwyUUAV9DqEN5yb2fI4Do\",\"type\":\"m.room.member\",\"unsigned\":{}}"];
...
- (void)testUserAvatarUrlFromEventWithNonMXCAvatarUrlContent {
    MXEvent *event = [self eventFromJSON:@"{\"sender\":\"@alice:sdn.org\",\"content\":{\"displayname\":\"bob\",\"avatar_url\":\"http://foo.bar\",\"membership\":\"join\"},\"origin_server_ts\":1616488993287,\"state_key\":\"@bob:sdn.org\",\"room_id\":\"!foofoofoofoofoofoo:sdn.org\",\"event_id\":\"$lGK3budX5w009ErtQwE9ZFhwyUUAV9DqEN5yb2fI4Do\",\"type\":\"m.room.member\",\"unsigned\":{}}"];
