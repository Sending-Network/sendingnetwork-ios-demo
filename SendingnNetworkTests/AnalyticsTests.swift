...
class AnalyticsTests: XCTestCase {
    func testAnalyticsPromptNewUser() {
        ...
        SendingnNetworkSettings.defaults.removeObject(forKey: SendingnNetworkSettings.UserDefaultsKeys.enableAnalytics)
        SendingnNetworkSettings.defaults.removeObject(forKey: SendingnNetworkSettings.UserDefaultsKeys.matomoAnalytics)
    ...
    func testAnalyticsPromptUpgradeFromMatomo() {
        ...
        SendingnNetworkSettings.defaults.removeObject(forKey: SendingnNetworkSettings.UserDefaultsKeys.enableAnalytics)
        SendingnNetworkSettings.defaults.set(true, forKey: SendingnNetworkSettings.UserDefaultsKeys.matomoAnalytics)
    ...
    func testAnalyticsPromptUserDeclinedMatomo() {
        ...
        SendingnNetworkSettings.defaults.removeObject(forKey: SendingnNetworkSettings.UserDefaultsKeys.enableAnalytics)
        SendingnNetworkSettings.defaults.set(false, forKey: SendingnNetworkSettings.UserDefaultsKeys.matomoAnalytics)
    ...
    func testAnalyticsPromptUserAcceptedPostHog() {
        ...
        SendingnNetworkSettings.defaults.set(true, forKey: SendingnNetworkSettings.UserDefaultsKeys.enableAnalytics)
