...
class UniversalLinkTests: XCTestCase {
    ...
    func testRegistrationLink() throws {
        guard let url = URL(string: "https://app.sendingnetwork.io/#/register/?hs_url=sdn.example.com&is_url=identity.example.com") else {
            throw UniversalLinkTestError.invalidURL
        }
        let universalLink = UniversalLink(url: url)
        XCTAssertEqual(universalLink.url, url)
        ...
        XCTAssertEqual(universalLink.nodeUrl, "sdn.example.com")
        XCTAssertEqual(universalLink.identityServerUrl, "identity.example.com")
    }

    func testLoginLink() throws {
        guard let url = URL(string: "https://mobile.sendingnetwork.io/?hs_url=sdn.example.com&is_url=identity.example.com") else {
            throw UniversalLinkTestError.invalidURL
        }
        let universalLink = UniversalLink(url: url)
        XCTAssertEqual(universalLink.url, url)
    ...
    func testPathParams() throws {
        guard let url = URL(string: "https://mobile.sendingnetwork.io/#/param1/param2/param3?hs_url=sdn.example.com&is_url=identity.example.com") else {
            throw UniversalLinkTestError.invalidURL
        }
        let universalLink = UniversalLink(url: url)
        XCTAssertEqual(universalLink.url, url)
    ...
    func testVia() throws {
        guard let url = URL(string: "https://mobile.sendingnetwork.io/?hs_url=sdn.example.com&is_url=identity.example.com&via=param1&via=param2") else {
            throw UniversalLinkTestError.invalidURL
        }
        let universalLink = UniversalLink(url: url)
        XCTAssertEqual(universalLink.url, url)
    ...
    func testDescription() throws {
        let str = "https://mobile.sendingnetwork.io/?hs_url=sdn.example.com&is_url=identity.example.com&via=param1&via=param2"
