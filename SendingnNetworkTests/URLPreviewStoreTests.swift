...
class URLPreviewStoreTests: XCTestCase {
    ...
    /// Creates mock URL preview data for sdn.org
    func sdnPreview() -> URLPreviewData {
        let preview = URLPreviewData(url: URL(string: "https://www.sdn.org/")!,
                                     eventID: "",
                                     roomID: "",
                                     siteName: "SDN",
                                     title: "Home",
    ...
    /// Creates mock URL preview data for sendingnetwork.io
    func elementPreview() -> URLPreviewData {
        URLPreviewData(url: URL(string: "https://sendingnetwork.io/")!,
                       eventID: "",
                       roomID: "",
                       siteName: "Element",
                       title: "Home",
                       text: "Secure and independent communication, connected via SDN")
    }
