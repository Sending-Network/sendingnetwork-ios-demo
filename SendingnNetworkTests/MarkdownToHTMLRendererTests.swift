...
final class MarkdownToHTMLRendererTests: XCTestCase {
    ...
    func testRenderAutolinks() {
        let input = [
            "Test1:",
            "<#_foonetic_xkcd:sdn.org>",
            "<http://google.com/_thing_>",
            "<https://sdn.org/_api/client/foo/123_>",
            "<#_foonetic_xkcd:sdn.org>",
            "",
            "Test1A:",
            "<#_foonetic_xkcd:sdn.org>",
            ...
            "",
            "Test3:",
            "<https://SendingnNetwork.im/app/#/room/#_foonetic_xkcd:sdn.org>",
            "<https://SendingnNetwork.im/app/#/room/#_foonetic_xkcd:sdn.org>",
        ].joined(separator: "\n")
        let expectedOutput = [
            "<p>Test1:\n&lt;#_foonetic_xkcd:sdn.org&gt;\n<a href=\"http://google.com/_thing_\">http://google.com/_thing_</a>\n<a href=\"https://sdn.org/_api/client/foo/123_\">https://sdn.org/_api/client/foo/123_</a>\n&lt;#_foonetic_xkcd:sdn.org&gt;</p>",
            "<p>Test1A:\n&lt;#_foonetic_xkcd:sdn.org&gt;\n<a href=\"http://google.com/_thing_\">http://google.com/_thing_</a>\n<a href=\"https://sdn.org/_api/client/foo/123_\">https://sdn.org/_api/client/foo/123_</a>\n&lt;#_foonetic_xkcd:sdn.org&gt;</p>",
            ...
            "<p>Test3:\n<a href=\"https://SendingnNetwork.im/app/#/room/#_foonetic_xkcd:sdn.org\">https://SendingnNetwork.im/app/#/room/#_foonetic_xkcd:sdn.org</a>\n<a href=\"https://SendingnNetwork.im/app/#/room/#_foonetic_xkcd:sdn.org\">https://SendingnNetwork.im/app/#/room/#_foonetic_xkcd:sdn.org</a></p>",
            "",
        ].joined(separator: "\n")
    ...
    func testRenderRepairedLinks() {
        ...
        let expectedOutput = [
            ...
            "<p>Test3:\nhttps://SendingnNetwork.im/app/#/room/#_foonetic_xkcd:sdn.org\nhttps://SendingnNetwork.im/app/#/room/#_foonetic_xkcd:sdn.org</p>",
            "",
        ].joined(separator: "\n")
        testRenderHTML(input: input, expectedOutput: expectedOutput)
    }
    ...
    func testRenderRepairedLinksWithStrongFormatting() {
        let input = "https://github.com/sdn-org/synapse/blob/develop/synapse/module_api/__init__.py"
        + " "
        + "https://github.com/sdn-org/synapse/blob/develop/synapse/module_api/__init__.py"
        let expectedOutput = "<p>https://github.com/sdn-org/synapse/blob/develop/synapse/module_api/__init__.py"
        + " "
        + "https://github.com/sdn-org/synapse/blob/develop/synapse/module_api/__init__.py</p>"
        + "\n"
        testRenderHTML(input: input, expectedOutput: expectedOutput)
    }
    ...
    func testRenderRepairedLinksWithCharactersRequiringPercentEncoding() {
        ...
        + "https://sdn.to/#/#_oftc_#sdn-dev:sdn.org"
        + " "
        + "https://sdn.to/#/#?=+-_#_"
        + "\n"
    ...
    func testRenderLinksInCodeblock() {
        ...
        + "```"
        let expectedOutput = [
            "<pre><code class=\"language-Test1:\">#_foonetic_xkcd:sdn.org",
            "http://google.com/_thing_",
            "https://sdn.org/_api/client/foo/123_",
            "#_foonetic_xkcd:sdn.org",
            "",
