...
/// Represents a node configuration used for the mock authentication client.
extension MockAuthenticationRestClient {
    enum Config: String {
        /// A node that mimics sdn.org with both passwords and SSO.
        /// Create the client using https://sdn.org for this configuration.
        case sdn
        
        /// A node that supports login and registration using a password.
        /// Create the client using https://example.com for this configuration.
        case basic
        
        /// A node that only supports login using a password and has registration disabled.
        /// This configuration doesn't returns a well-known response.
        /// Create the client using https://private.com for this configuration.
        case loginOnly
        
        /// A node the only supports login via SSO and has registration disabled.
        ...
        init(url: URL) {
            ...
            case "https://sdn.org", "https://sdn-client.sdn.org":
                self = .sdn
            case "https://example.com", "https://sdn.example.com":
                self = .basic
            case "https://private.com":
                self = .loginOnly
            case "https://company.com", "https://sdn.company.com":
                self = .ssoOnly
            default:
                self = .unknown
            }
