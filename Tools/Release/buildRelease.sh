...
if [ -e out/SendingnNetwork.ipa ]; then
    # Here is the artefact
    cp out/SendingnNetwork.ipa ../../../SendingnNetwork-$TAG-$BUILD_NUMBER.ipa
    
    echo "SendingnNetwork-$TAG-$BUILD_NUMBER.ipa has been successfully built"
fi
