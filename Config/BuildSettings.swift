...
final class BuildSettings: NSObject {
    ...
    /// Force the user to set a node instead of using the default one
    ...
    static let applicationCopyrightUrlString = "https://sendingnetwork.io/copyright"
    static let applicationPrivacyPolicyUrlString = "https://sendingnetwork.io/privacy"
    static let applicationAcceptableUsePolicyUrlString = "https://sendingnetwork.io/acceptable-use-policy-terms"
    static let applicationHelpUrlString =
    "https://sendingnetwork.io/help"
    ...
    static let permalinkSupportedHosts: [String: [String]] = [
        "app.sendingnetwork.io": [],
        "staging.sendingnetwork.io": [],
        "develop.sendingnetwork.io": [],
        "mobile.sendingnetwork.io": [""],
        // Historical ones
        "SendingnNetwork.im": ["/app", "/staging", "/develop"],
        "www.SendingnNetwork.im": ["/app", "/staging", "/develop"],
...
//        "www.example.com": ["/"],
    ...
    // For use in clients that use a custom base url for permalinks rather than sdn.to.
    // This baseURL is used to generate permalinks within the app (E.g. timeline message permalinks).
    // Optional String that when set is used as permalink base, when nil sdn.to format is used.
    ...
    static let stunServerFallbackUrlString: String? = "stun:turn.sdn.org"
    
    // MARK: -  Public rooms Directory
    // List of nodes for the public rooms directory
    ...
    static let analyticsConfiguration = AnalyticsConfiguration(isEnabled: BuildSettings.baseBundleIdentifier.starts(with: "sending.me.app"),
                                                               host: "https://posthog.element.dev",
                                                               apiKey: "phc_VtA1L35nw3aeAtHIx1ayrGdzGkss7k1xINeXcoIQzXN",
                                                               termsURL: URL(string: "https://sendingnetwork.io/cookie-policy")!)
    #else
    /// The configuration to use for analytics. Set `isEnabled` to false to disable analytics.
    static let analyticsConfiguration = AnalyticsConfiguration(isEnabled: BuildSettings.baseBundleIdentifier.starts(with: "sending.me.app"),
                                                               host: "https://posthog.sendingnetwork.io",
    ...
    // MARK: - Bug report
    static let bugReportEndpointUrlString = "https://SendingnNetwork.im/bugreports"
    // Use the name allocated by the bug report server
    static let bugReportApplicationId = "SendingnNetwork-ios"
    ...
    static let integrationsScalarWidgetsPaths = [
        "https://scalar.vector.im/_api/integrations/v1",
        "https://scalar.vector.im/api",
        "https://scalar-staging.vector.im/_api/integrations/v1",
        "https://scalar-staging.vector.im/api",
        "https://scalar-staging.SendingnNetwork.im/scalar/api",
    ]
    ...
    /// Whether to read the `io.sendingnetwork.functional_members` state event and exclude any service members when computing a room's name and avatar.
