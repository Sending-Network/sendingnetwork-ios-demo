...
public class VectorL10n: NSObject {
  ...
  /// SDN session is not opened
  public static var accountErrorSdnSessionIsNotOpened: String { 
    return VectorL10n.tr("Vector", "account_error_sdn_session_is_not_opened") 
  }
  /// Link Email
  ...
  /// This file contains encryption keys exported from a SDN client.\nDo you want to view the file content or import the keys it contains?
  ...
  /// Please review and accept the policies of this node:
  ...
  /// Invalid node discovery response
  ...
  /// No identity server is configured so you cannot add an email address in order to reset your SDN account password in the future.
  ...
  /// Forgot SDN account password?
  public static var authForgotPassword: String { 
    return VectorL10n.tr("Vector", "auth_forgot_password") 
  }
  /// No identity server is configured: add one to reset your SDN account password.
  ...
  /// No identity server is configured so you cannot add a phone number in order to reset your SDN account password in the future.
  ...
  /// This node would like to make sure you are not a robot
  ...
  /// Confirm your new SDN account password
  ...
  /// No identity server is configured: add one in server options to reset your SDN account password.
  ...
  /// Your email address does not appear to be associated with a SDN ID on this node.
  ...
  /// To reset your SDN account password, enter the email address linked to your account:
  ...
  /// Your SDN account password has been reset.\n\nYou have been logged out of all sessions and will no longer receive push notifications. To re-enable notifications, re-log in on each device.
  ...
  /// Your node (%1$@) admin has signed you out of your account %2$@ (%3$@).
  ...
  /// This app does not support the authentication mechanism on your node.
  ...
  /// Please ask the administrator of your node %@ to configure a TURN server in order for calls to work reliably.
  ...
  /// SDN users only
  public static var contactsAddressBookSdnUsersToggle: String { 
    return VectorL10n.tr("Vector", "contacts_address_book_sdn_users_toggle") 
  }
  /// LOCAL CONTACTS
  ...
  /// If you would like us to forget your messages, please tick the box below\n\nMessage visibility in SDN is similar to email. Our forgetting your messages means that messages you have sent will not be shared with any new or unregistered users, but registered users who already have access to these messages will still have access to their copy.
  ...
  /// To continue, please enter your SDN account password
  ...
  /// This works with %@ and other cross-signing capable SDN clients.
  ...
  /// Type a node to list public rooms from
  public static var directoryServerTypeNode: String { 
    return VectorL10n.tr("Vector", "directory_server_type_node") 
  }
  /// Directory
  ...
  /// This process allows you to export the keys for messages you have received in encrypted rooms to a local file. You will then be able to import the file into another SDN client in the future, so that client will also be able to decrypt these messages.\nThe exported file will allow anyone who can read it to decrypt any encrypted messages that you can see, so you should be careful to keep it secure.
  ...
  /// This process allows you to import encryption keys that you had previously exported from another SDN client. You will then be able to decrypt any messages that the other client could decrypt.\nThe export file is protected with a passphrase. You should enter the passphrase here, to decrypt the file.
  ...
  /// You need to log back in to generate end-to-end encryption keys for this session and submit the public key to your node.\nThis is a once off; sorry for the inconvenience.
  ...
  /// It looks like you’re trying to connect to another node. Do you want to sign out?
  ...
  /// To continue using the %@ node you must review and agree to the terms and conditions.
  ...
  /// Malformed ID. Should be a SDN ID like '@localpart:domain'
  ...
  /// I'd like to chat with you with sdn. Please, visit the website http://sdn.org to have more information.
  ...
  /// To discover contacts already using SDN, %@ can send email addresses and phone numbers in your address book to your chosen SDN identity server. Where supported, personal data is hashed before sending - please check your identity server's privacy policy for more details.
  ...
  /// Unable to load map\nThis node is not configured to display maps
  ...
  /// Specify an email address lets other users find you on SDN more easily, and will give you a way to reset your password in the future.
  ...
  /// Currently we do not support any or all login flows defined by this node
  ...
  /// We failed to retrieve authentication information from this node
  ...
  /// This node has exceeded one of its resource limits.
  ...
  /// This node has hit its Monthly Active User limit.
  ...
  /// Your node stores all your conversations and account data
  ...
  /// SDN provides identity servers to track which emails etc. belong to which SDN IDs. Only https://sdn.org currently exists.
  ...
  public static var nodeConnectionLost: String { 
    return VectorL10n.tr("Vector", "node_connection_lost") 
  }
  /// Not supported yet
  ...
  /// Choose where your conversations are kept, giving you control and independence. Connected via SDN.
  ...
  /// (e.g. #foo%@)
  public static func roomCreationAliasPlaceholderWithNode(_ p1: String) -> String {
    return VectorL10n.tr("Vector", "room_creation_alias_placeholder_with_node", p1)
  }
  /// Room alias:
  ...
  /// Unable to find profiles for this SDN ID. Would you like to start a DM anyway?
  ...
  /// Malformed ID. Should be an email address or a SDN ID like '@localpart:domain'
  ...
  /// Unable to find profiles for this SDN ID. Are you sure you want to invite %@ to %@?
  ...
  /// This node has exceeded one of its resource limits so 
  ...
  /// This node has hit its Monthly Active User limit so 
  ...
  /// SDN
  public static var sdn: String { 
    return VectorL10n.tr("Vector", "sdn") 
  }
  /// Search
  ...
  /// Enter your SDN account password to confirm
  ...
  /// Don't use your SDN account password.
  ...
  /// Sorry. This action is not available on %@ iOS yet. Please use another SDN client to set it up. %@ iOS will use it.
  ...
  /// If you don’t recognise a login, change your SDN account password and reset Secure Backup.
  ...
  /// Confirm your identity by entering your SDN account password
  ...
  /// Allow fallback call assist server %@ when your node does not offer one (your IP address would be shared during a call).
  ...
  /// Fail to update SDN account password
  ...
  /// Your SDN account password has been updated
  ...
  /// Node URL: %@
  public static func sslNodeUrl(_ p1: String) -> String {
    return VectorL10n.tr("Vector", "ssl_node_url", p1)
  }
  ...
  /// Element is a new type of messenger and collaboration app that:\n\n1. Puts you in control to preserve your privacy\n2. Lets you communicate with anyone in the SDN network, and even beyond by integrating with apps such as Slack\n3. Protects you from advertising, datamining, backdoors and walled gardens\n4. Secures you through end-to-end encryption, with cross-signing to verify others\n\nElement is completely different from other messaging and collaboration apps because it is decentralised and open source.\n\nElement lets you self-host - or choose a host - so that you have privacy, ownership and control of your data and conversations. It gives you access to an open network; so you’re not just stuck speaking to other Element users only. And it is very secure.\n\nElement is able to do all this because it operates on SDN - the standard for open, decentralised communication. \n\nElement puts you in control by letting you choose who hosts your conversations. From the Element app, you can choose to host in different ways:\n\n1. Get a free account on the sdn.org public server\n2. Self-host your account by running a server on your own hardware\n3. Sign up for an account on a custom server by simply subscribing to the Element SDN Services hosting platform\n\nWhy choose Element?\n\nOWN YOUR DATA: You decide where to keep your data and messages. You own it and control it, not some MEGACORP that mines your data or gives access to third parties.\n\nOPEN MESSAGING AND COLLABORATION: You can chat with anyone else in the SDN network, whether they’re using Element or another SDN app, and even if they are using a different messaging system of the likes of Slack, IRC or XMPP.\n\nSUPER-SECURE: Real end-to-end encryption (only those in the conversation can decrypt messages), and cross-signing to verify the devices of conversation participants.\n\nCOMPLETE COMMUNICATION: Messaging, voice and video calls, file sharing, screen sharing and a whole bunch of integrations, bots and widgets. Build rooms, communities, stay in touch and get things done.\n\nEVERYWHERE YOU ARE: Stay in touch wherever you are with fully synchronised message history across all your devices and on the web at https://sendingnetwork.io/app.
  ...
  /// Your node does not currently support threads, so this feature may be unreliable. Some threaded messages may not be reliably available. 
  ...
  /// All threads created during the experimental period will now be <b>rendered as regular replies</b>.<br/><br/>This will be a one-off transition, as threads are now part of the SDN specification.
  ...
  /// This session doesn't support encryption, so it can't be verified.\n\nYou won't be able to participate in rooms where encryption is enabled when using this session.\n\nFor best security and privacy, it is recommended to use SDN clients that support encryption.
