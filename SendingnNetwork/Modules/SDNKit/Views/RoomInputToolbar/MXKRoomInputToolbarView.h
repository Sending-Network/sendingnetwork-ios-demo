...
/**
 Tells the delegate that the user wants invite a sdn user.
 
 Note: `Invite sdn user` option is displayed in actions list only if the delegate implements this method.
 
 @param toolbarView the room input toolbar view.
 @param mxUserId the SDN user id.
 */
- (void)roomInputToolbarView:(MXKRoomInputToolbarView*)toolbarView inviteSDNUser:(NSString*)mxUserId;
