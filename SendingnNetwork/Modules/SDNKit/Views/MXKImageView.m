...
- (void)setHideActivityIndicator:(BOOL)hideActivityIndicator
{
    ...
    {
        NSString *downloadId = [MXMediaManager downloadIdForSDNContentURI:mxcURI inFolder:mediaFolder];
       ...
       mediaManager:(MXMediaManager*)mediaManager
{
    ...
    if (isThumbnail)
    {
        cacheFilePath = [MXMediaManager thumbnailCachePathForSDNContentURI:mxcURI
                                                                      andType:mimeType
    ...
    {
        cacheFilePath = [MXMediaManager cachePathForSDNContentURI:mxcURI
                                                             andType:mimeType
                                                            inFolder:mediaFolder];
    }
    ...
    else
    {
        ...
        if (isThumbnail)
        {
            downloadId = [MXMediaManager thumbnailDownloadIdForSDNContentURI:mxcURI
                                                                       inFolder:mediaFolder
                                                                  toFitViewSize:thumbnailViewSize
                                                                     withMethod:thumbnailMethod];
        }
        ...
        {
            downloadId = [MXMediaManager downloadIdForSDNContentURI:mxcURI inFolder:mediaFolder];
        }
        ...
        if (!loader && mediaManager)
        {
            ...
            if (isThumbnail)
            {
                loader = [mediaManager downloadThumbnailFromSDNContentURI:mxcURI
                                                                    withType:mimeType
                                                                    inFolder:mediaFolder
                                                               toFitViewSize:thumbnailViewSize
                                                                  withMethod:thumbnailMethod
            ...
            {
                loader = [mediaManager downloadMediaFromSDNContentURI:mxcURI
                                                                withType:mimeType
                                                                inFolder:mediaFolder];
            }
        }
