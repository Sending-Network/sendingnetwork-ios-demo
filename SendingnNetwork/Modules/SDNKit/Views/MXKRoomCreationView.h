...
/**
 Tells the delegate to open the room with the provided identifier in a specific sdn session.
 
 @param creationView the view.
 @param roomId the room identifier.
 @param mxSession the sdn session in which the room should be available.
 */
- (void)roomCreationView:(MXKRoomCreationView*)creationView showRoom:(NSString*)roomId withSDNSession:(MXSession*)mxSession;
@end
