...
- (void)openRecaptchaWidgetWithSiteKey:(NSString*)siteKey fromNode:(NSString*)Node callback:(void (^)(NSString *response))callback
{
    ...
    [self loadHTMLString:htmlString baseURL:[NSURL URLWithString:Node]];
}
