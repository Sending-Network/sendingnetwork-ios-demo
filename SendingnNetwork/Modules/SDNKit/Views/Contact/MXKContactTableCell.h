...
typedef enum : NSUInteger {
    ...
    /**
     The accessory view is automatically handled. It shown only for contact with sdn identifier(s).
     */
    MXKContactTableCellAccessorySDNIcon
...
@property (strong, nonatomic) IBOutlet UILabel *sdnDisplayNameLabel;
@property (strong, nonatomic) IBOutlet UILabel *sdnIDLabel;
...
/**
 Tell whether the sdn presence of the contact is displayed or not (NO by default)
 */
@property (nonatomic) BOOL hideSDNPresence;
