...
- (instancetype)initWithDevice:(MXDevice*)device andSDNSession:(MXSession*)session
{
    ...
    [currentAlert addAction:[UIAlertAction actionWithTitle:[VectorL10n ok]
                                                   ...
                                                   handler:^(UIAlertAction * action) {
                                                       ...
                                                       if (weakSelf)
                                                       {
                                                           ...
                                                           self->mxCurrentOperation = [self->mxSession.sdnRestClient setDeviceName:text forDeviceId:self->mxDevice.deviceId success:^{
...
- (void)deleteDevice
{
    ...
    mxCurrentOperation = [mxSession.sdnRestClient getSessionToDeleteDeviceByDeviceId:mxDevice.deviceId success:^(MXAuthenticationSession *authSession) {
            ...
            [self->currentAlert addAction:[UIAlertAction actionWithTitle:[VectorL10n submit]
                                                           ...
                                                           handler:^(UIAlertAction * action) {
                                                               ...
                                                               if (weakSelf)
                                                               {
                                                                   ...
                                                                   self->mxCurrentOperation = [self->mxSession.sdnRestClient deleteDeviceByDeviceId:self->mxDevice.deviceId authParams:authParams success:^{
