...
/**
 ...
 Use the `initWithSDNSession:` constructor to search in all user's rooms.
 Use the `initWithRoomId:andSDNSession: constructor to search in a specific room.
 */
...
/**
 Launch a message search node side.
...
/**
 Convert the results of a node search requests into cells.
 
 This methods is in charge of filling `cellDataArray`.
 
 @param roomEventResults the node response as provided by SDNSDK.
