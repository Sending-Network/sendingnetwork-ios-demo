...
- (instancetype)initWithEvent:(MXEvent *)event andRoomState:(MXRoomState *)roomState andRoomDataSource:(MXKRoomDataSource *)roomDataSource
{
    ...
    if (self)
    {
        ...
        // Create the bubble component based on sdn event
        ...
        if (firstComponent)
        {
            ...
            MXRoomState *displayRoomState = SendingnNetworkSettings.shared.roomScreenUseOnlyLatestUserAvatarAndName ? latestRoomState : roomState;
...
{
    if (SendingnNetworkSettings.shared.roomScreenUseOnlyLatestUserAvatarAndName)
    {
