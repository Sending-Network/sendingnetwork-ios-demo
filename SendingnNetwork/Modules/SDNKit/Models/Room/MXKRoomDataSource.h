...
/**
 A Boolean value that determines whether the date time labels are customized (By default date time display is handled by SDNKit). NO by default.
 */
...
/**
 A Boolean value that determines whether the read receipts are customized (By default read receipts display is handled by SDNKit). NO by default.
 */
...
/**
 A Boolean value that determines whether the unsent button is customized (By default an 'Unsent' button is displayed by SDNKit in front of unsent events). NO by default.
 */
...
/**
 ...
 @param mxSession the SDN session to get data from.
...
+ (void)loadRoomDataSourceWithRoomId:(NSString*)roomId
                    ...
                    andSDNSession:(MXSession*)mxSession
 ...
 */
- (instancetype)initWithRoomId:(NSString*)roomId andSDNSession:(MXSession*)mxSession threadId:(NSString*)threadId;
...
/**
 ...
 @param onlyFromStore if YES, return available events from the store, do not make a pagination request to the node.
...
/**
 ...
 @param direction backwards or forwards.
 @param minRequestMessagesCount if messages are not available in the store, a request to the node
...
/**
 ...
 Once complete, this local echo will be replaced by the event saved by the node.

 @param text the text to send.
 @param success A block object called when the operation succeeds. It returns
                the event id of the event generated on the node
