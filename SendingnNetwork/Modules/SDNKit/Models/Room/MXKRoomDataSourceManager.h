...
/**
 `MXKRoomDataSourceManager` manages a pool of `MXKRoomDataSource` instances for a given SDN session.
...
/**
 Retrieve the MXKRoomDataSources manager for a particular SDN session.
 
 @param mxSession the SDN session,
...
/**
 Remove the MXKRoomDataSources manager for a particular SDN session.
...
/**
 Tells whether a server sync is in progress in the sdn session.
 */
