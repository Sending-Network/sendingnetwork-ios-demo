...
- (id)initWithCoder:(NSCoder *)coder
{
    ...
    if (self)
    {
        ...
        NSString *NodeURL = [coder decodeObjectForKey:@"nodeurl"];
        ...
        _mxCredentials = [[MXCredentials alloc] initWithNode:NodeURL
                                                           userId:userId
...
{
    [coder encodeObject:_mxCredentials.node forKey:@"nodeurl"];
