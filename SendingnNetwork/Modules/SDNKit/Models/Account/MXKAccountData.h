...
/**
 The account's credentials: node, access token, user id.
 */
...
/**
 Flag to indicate that an APNS pusher has been set on the node for this device.
 */
...
/**
 Flag to indicate that a PushKit pusher has been set on the node for this device.
 */
...
/**
 ...
 A sdn session is automatically opened for the account when this property is toggled from YES to NO.
...
/**
 Flag to indicate if the account has been logged out by the node admin.
 */
