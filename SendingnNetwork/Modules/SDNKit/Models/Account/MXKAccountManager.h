...
/**
 Posted when the user logged in with a sdn account.
...
/**
 The class of store used to open sdn session for the accounts. This class must be conformed to MXStore protocol.
...
/**
 Check for each enabled account if a sdn session is already opened.
 Open a sdn session for each enabled account which doesn't have a session.
...
/**
 Add an account and save the new account list. Optionally a sdn session may be opened for the provided account.
 
 @param account a sdn account.
 @param openSession YES to open a sdn session (this value is ignored if the account is disabled).
 */
...
/**
 ...
 @param account a sdn account.
 @param sendLogoutRequest Indicate whether send logout request to node.
 @param completion the block to execute at the end of the operation.
 */
