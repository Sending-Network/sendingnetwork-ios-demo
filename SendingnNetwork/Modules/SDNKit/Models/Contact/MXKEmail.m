...
- (id)initWithEmailAddress:(NSString*)anEmailAddress type:(NSString*)aType contactID:(NSString*)aContactID sdnID:(NSString*)sdnID
{
    self = [super initWithContactID:aContactID sdnID:sdnID];
