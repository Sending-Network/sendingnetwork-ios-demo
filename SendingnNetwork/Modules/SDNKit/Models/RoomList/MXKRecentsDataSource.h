...
/**
 'MXKRecentsDataSource' is a base class to handle recents from one or multiple sdn sessions.
...
/**
 List of associated sdn sessions.
 */
...
/**
 Add recents data from a sdn session.
 
 @param mxSession the SDN session to retrieve contextual data.
 @return the new 'MXKSessionRecentsDataSource' instance created for this SDN session.
 */
- (MXKSessionRecentsDataSource *)addSDNSession:(MXSession*)mxSession;

/**
 Remove recents data related to a sdn session.
