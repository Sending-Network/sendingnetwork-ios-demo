...
/**
 `MXKAppSettings` represents the application settings. Most of them are used to handle sdn session data.
...
/**
 Lazy load room members when /syncing with the node.
 */
...
/**
 ...
 The default value of this property only contains the sdn.to host.
 */
...
/**
 Color associated to online sdn users.
...
/**
 Color associated to unavailable sdn users.
...
/**
 Color associated to offline sdn users.
...
/**
 ...
 The default group is "group.org.sdn".
 */
...
/**
 Return the folder to use for caching SDNKit data.
 */
