...
/**
 ...
 @param restClient used to make sdn API requests during validation process.
 ...
 */
- (void)requestValidationTokenWithSDNRestClient:(MXRestClient*)restClient
...
/**
 ...
 @param bind whether the node should also bind this third party identifier
        to the account's SDN ID with the identity server.
