...
/**
 `MXKDataSource` is the base class for data sources managed by SDNKit.
...
/**
 ...
 1- call [MXKDataSource initWithSDNSession:] to initialize a new allocated object.
...
/**
 Finalize the initialization by adding an observer on sdn session state change.
 */
...
/**
 This method is called when the state of the attached SDN session has changed.
 */
...
/**
 ...
 Tells the delegate that a sdn session has been added.
...
/**
 Relevant only for data source which support multi-sessions.
 Tells the delegate that a sdn session has been removed.
