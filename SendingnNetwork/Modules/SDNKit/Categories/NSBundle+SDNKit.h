...
/**
 Define a `NSBundle` category at SDNKit level to retrieve images and sounds from SDNKit Assets bundle.
 */
@interface NSBundle (SDNKit)

/**
 Retrieve an image from SDNKit Assets bundle.
...
/**
 Retrieve an audio file url from SDNKit Assets bundle.
