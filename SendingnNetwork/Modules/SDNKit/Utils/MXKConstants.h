...
/**
 The SDN iOS Kit version.
 */
FOUNDATION_EXPORT NSString *const SDNKitVersion;

/**
 Posted when an error is observed at SDN Kit level.
 ...
 - `kMXKErrorUserIdKey` the sdn identifier of the account concerned by this error.
 */
