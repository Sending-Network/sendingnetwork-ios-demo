...
/**
 Make some sdn identifiers clickable in the string content.
 
 @param mutableAttributedString a mutable attributed string.
 @param enabledSDNIdsBitMask the bitmask used to list the types of sdn id to process (see MXKTOOLS_XXX__BITWISE).
 */
