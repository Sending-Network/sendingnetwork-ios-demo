...
/**
 ...
 @param mxSession the sdn session in which the room is defined.
 */
- (void)recentListViewController:(MXKRecentListViewController *)recentListViewController didSelectRoom:(NSString*)roomId inSDNSession:(MXSession*)mxSession;
