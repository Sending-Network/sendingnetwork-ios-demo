...
/**
 ...
 @param sdnId the member's sdn id
 ...
 */
- (void)roomMemberDetailsViewController:(MXKRoomMemberDetailsViewController *)roomMemberDetailsViewController placeVoipCallWithMemberId:(NSString*)sdnId andVideo:(BOOL)isVideoCall;
...
@property (weak, nonatomic) IBOutlet UITextView *roomMemberSDNInfo;
...
/**
 ...
 @param roomMember the sdn room member
 @param room the sdn room to which this member belongs.
 */
- (void)displayRoomMember:(MXRoomMember*)roomMember withSDNRoom:(MXRoom*)room;
