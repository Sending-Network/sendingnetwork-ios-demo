...
/**
 MXKAccountDetailsViewController instance may be used to display/edit the details of a sdn account.
 Only one sdn session is handled by this view controller.
 */
