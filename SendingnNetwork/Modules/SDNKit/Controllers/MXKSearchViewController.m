...
- (void)displaySearch:(MXKSearchDataSource*)searchDataSource
{
    ...
    if (dataSource)
    {
        ...
        [self removeSDNSession:dataSource.mxSession];
    ...
    // Report the related sdn sessions at view controller level to update UI according to sessions state
    [self addSDNSession:searchDataSource.mxSession];
