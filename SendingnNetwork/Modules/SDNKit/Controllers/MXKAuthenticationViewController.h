...
/**
 This view controller should be used to manage registration or login flows with sdn node.
...
/**
 The default node url (nil by default).
 */
@property (nonatomic) NSString *defaultNodeUrl;
...
/**
 Handle supported flows and associated information returned by the node.
...
/**
 Set the node url and force a new authentication session.
 The default node url is used when the provided url is nil.
...
/**
 Fetch the identity server from the wellknown API of the selected node.
