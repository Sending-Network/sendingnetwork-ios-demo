...
/**
 ...
 This view controller support multi sessions by collecting all sdn users (only one occurrence is kept by user).
 */
...
/**
 The segmented control used to handle separatly sdn users and local contacts.
