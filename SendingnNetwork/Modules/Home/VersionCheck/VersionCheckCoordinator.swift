...
class VersionCheckCoordinator: Coordinator, VersionCheckBannerViewDelegate, VersionCheckAlertViewControllerDelegate {
    ...
    func start() {
        ...
        let versionCheckNextDisplayDateTimeInterval = SendingnNetworkSettings.shared.versionCheckNextDisplayDateTimeInterval
    ...
    private func dismissVersionCheckBanner() {
        ...
        SendingnNetworkSettings.shared.versionCheckNextDisplayDateTimeInterval = nextDisplayDate?.timeIntervalSince1970 ?? 0.0
    }
