    ...
    if (cellData)
    {
        ...
        if (selectedCollectionViewContentOffset != -1 && collectionView.tag == selectedSection)
        {
            ...
            if (editedRoomId)
            {
                ...
                NSIndexPath *indexPath = [self.dataSource cellIndexPathWithRoomId:editedRoomId andSDNSession:self.mainSession];
    ...
    if (self.delegate)
    {
        ...
        else
        {
            [self.delegate recentListViewController:self
                                    ...
                                    inSDNSession:renderedCellData.mxSession];
        }
    }
    ...
    if (gestureRecognizer.state == UIGestureRecognizerStateBegan)
    {
        ...
        if ([view isKindOfClass:[RoomCollectionViewCell class]])
        {
            ...
            if (room)
            {
                ...
                NSIndexPath *collectionViewCellIndexPath = [self.dataSource cellIndexPathWithRoomId:selectedRoomId andSDNSession:room.mxSession];
