...
final class AllChatsLayoutSettingsManager: NSObject {
    ...
    var activeFilters: AllChatsLayoutFilterType {
        get {
            guard let value = SendingnNetworkSettings.defaults.object(forKey: Constants.activeFiltersKey) as? NSNumber else {
                return .all
            }
            return AllChatsLayoutFilterType(rawValue: value.uintValue)
        }
        set {
            SendingnNetworkSettings.defaults.set(newValue.rawValue, forKey: Constants.activeFiltersKey)
    ...
    var allChatLayoutSettings: AllChatsLayoutSettings {
        get {
            guard let data = SendingnNetworkSettings.defaults.data(forKey: Constants.settingsKey) else {
        ...
        set {
            ...
            SendingnNetworkSettings.defaults.set(data, forKey: Constants.settingsKey)
