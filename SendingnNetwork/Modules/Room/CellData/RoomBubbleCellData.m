    ...
    if (self)
    {
        ...
        switch (event.eventType)
        {
            ...
            case MXEventTypeCustom:
            {
                ...
                {
                    Widget *widget = [[Widget alloc] initWithWidgetEvent:event inSDNSession:roomDataSource.mxSession];
...
- (void)refreshURLPreviewForEventId:(NSString *)eventId
{
    ...
    component.showURLPreview = SendingnNetworkSettings.shared.roomScreenShowsURLPreviews && [URLPreviewService.shared shouldShowPreviewFor:component.event];
    if (!component.showURLPreview)
    {
        return;
    }
