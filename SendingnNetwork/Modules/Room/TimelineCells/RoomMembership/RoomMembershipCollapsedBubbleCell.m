...
- (void)render:(MXKCellData *)cellData
{
    ...
    do
    {
        ...
        // Handle user's picture by considering it is stored unencrypted on SDN media repository
        ...
        if (![content.membership isEqualToString:kMXMembershipStringJoin])
        {
            ...
            {
                nextBubbleData.targetAvatarPlaceholder = [AvatarGenerator generateAvatarForSDNItem:nextBubbleData.targetId withDisplayName:nextBubbleData.targetDisplayName];
            }
        ...
        else
        {
            ...
            {
                nextBubbleData.senderAvatarPlaceholder = [AvatarGenerator generateAvatarForSDNItem:nextBubbleData.senderId withDisplayName:nextBubbleData.senderDisplayName];
            }
