...
- (void)showResourceLimit:(NSString *)limitType adminContactString:(NSString *)adminContactString hardLimit:(BOOL)hardLimit onAdminContactTapped:(void (^)(NSURL *adminContact))onAdminContactTapped
{
    ...
    if (hardLimit)
    {
        // Reuse SDNKit as is for the beginning of hardLimit
    ...
    {
        self.backgroundColor = ThemeService.shared.SendingnNetworkColorCuriousBlue;
        self.messageTextView.backgroundColor = ThemeService.shared.SendingnNetworkColorCuriousBlue;
    }
