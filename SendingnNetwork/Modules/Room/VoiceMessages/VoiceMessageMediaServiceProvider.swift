...
@objc public class VoiceMessageMediaServiceProvider: NSObject, VoiceMessageAudioPlayerDelegate, VoiceMessageAudioRecorderDelegate {
    ...
    @objc public var currentRoomSummary: MXRoomSummary? {
        didSet {
            ...
            roomAvatar = AvatarGenerator.generateAvatar(forSDNItem: currentRoomSummary?.roomId,
            ...
            if let cachePath = MXMediaManager.thumbnailCachePath(forSDNContentURI: avatarUrl,
               ...
               FileManager.default.fileExists(atPath: cachePath) {
                ...
                roomAvatarLoader = mediaManager.downloadThumbnail(fromSDNContentURI: avatarUrl,
