...
- (IBAction)onAdd:(id)sender
{
    ...
    currentAlert = [UIAlertController alertControllerWithTitle:nil message:[VectorL10n directoryServerTypeNode] preferredStyle:UIAlertControllerStyleAlert];
                                                   ...
                                                   handler:^(UIAlertAction * action) {
                                                       ...
                                                       if (weakSelf)
                                                       {
                                                           ...
                                                           if (node.length)
                                                           {
                                                               ...
                                                               self->mxCurrentOperation = [self->dataSource.mxSession.sdnRestClient publicRoomsOnServer:node limit:20 since:nil filter:nil thirdPartyInstanceId:nil includeAllNetworks:YES success:^(MXPublicRoomsResponse *publicRoomsResponse) {
                                                                   ...
                                                                   if (weakSelf && self->mxCurrentOperation)
                                                                   {
                                                                       ...
                                                                       if (self->onCompleteBlock)
                                                                       {
                                                                           ...
                                                                           MXKDirectoryServerCellData *cellData = [[MXKDirectoryServerCellData alloc] initWithNode:node includeAllNetworks:YES];
