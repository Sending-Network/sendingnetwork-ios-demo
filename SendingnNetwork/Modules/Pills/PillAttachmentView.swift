...
class PillAttachmentView: UIView {
    ...
    convenience init(frame: CGRect,
        ...
        for item in pillData.items {
            ...
            case .avatar(let url, let alt, let sdnId):
                ...
                avatarView.fill(with: AvatarViewData(sdnItemId: sdnId,
                                                     displayName: alt,
                                                     avatarUrl: url,
                                                     mediaManager: mediaManager,
                                                     fallbackImage: .sdnItem(sdnId, alt)))
            ...
            case .spaceAvatar(let url, let alt, let sdnId):
