...
- (void)checkIdentityServerRequirement:(MXRestClient*)mxRestClient success:(void (^)(void))success failure:(void (^)(NSError *))failure
{
    [mxRestClient supportedSDNVersions:^(MXSDNVersions *sdnVersions) {
        ...
        MXLogDebug(@"[ForgotPasswordInputsView] checkIdentityServerRequirement: %@", sdnVersions.doesServerRequireIdentityServerParam ? @"YES": @"NO");

        if (sdnVersions.doesServerRequireIdentityServerParam
