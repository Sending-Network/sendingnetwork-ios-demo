...
final class TermsView: UIView, NibOwnerLoadable, UITableViewDelegate, UITableViewDataSource {
    ...
    private var navigationController: SendingnNetworkNavigationController?
    ...
    ///
    /// - Parameters:
    ///   - terms: Terms data sent by the node.
    ...
    func displayPolicy(policyIndex: Int) {
        ...
        navigationController = SendingnNetworkNavigationController()
