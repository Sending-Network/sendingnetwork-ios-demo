...
final class SSOAuthenticationService: NSObject {
    ...
    private let nodeStringURL: String
        
    let callBackURLScheme: String?
    
    // MARK: - Setup
    
    init(nodeStringURL: String) {
        self.nodeStringURL = nodeStringURL
    ...
    func authenticationURL(for identityProvider: String?, transactionId: String) -> URL? {
        guard var authenticationComponent = URLComponents(string: self.nodeStringURL) else {
            return nil
        }
