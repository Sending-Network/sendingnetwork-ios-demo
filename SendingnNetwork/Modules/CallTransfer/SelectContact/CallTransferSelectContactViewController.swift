...
final class CallTransferSelectContactViewController: UIViewController {
    ...
    private var contactsDataSource: ContactsDataSource! {
        didSet {
            for userId in ignoredUserIds {
                contactsDataSource.ignoredContactsBySDNId[userId] = MXKContact()
            }
    ...
    class func instantiate(withSession session: MXSession, ignoredUserIds: [String] = []) -> CallTransferSelectContactViewController {
        ...
        viewController.contactsDataSource = SDNContactsDataSource(sdnSession: session)
    ...
    private func updateSections() {
        ...
        for (index, user) in users.enumerated() {
            ...
            let row = Row(contact: MXKContact(sdnContactWithDisplayName: user.displayname,
                                              sdnID: user.userId,
                                              andSDNAvatarURL: user.avatarUrl),
...
extension CallTransferSelectContactViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.contactInformationLabel.text = row.contact.sdnIdentifiers.first as? String
