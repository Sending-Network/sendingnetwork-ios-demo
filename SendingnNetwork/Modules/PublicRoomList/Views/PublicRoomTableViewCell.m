...
- (void)render:(MXPublicRoom *)publicRoom withSDNSession:(MXSession*)mxSession
{
    ...
    // Set the avatar
    UIImage* avatarImage = [AvatarGenerator generateAvatarForSDNItem:publicRoom.roomId withDisplayName:self.roomDisplayName.text];
