...
final class EnterNewRoomDetailsViewController: UIViewController {
    ...
    private func updateSections() {
        ...
        if SendingnNetworkSettings.shared.roomCreationScreenAllowEncryptionConfiguration {
        ...
        if SendingnNetworkSettings.shared.roomCreationScreenAllowRoomTypeConfiguration {
