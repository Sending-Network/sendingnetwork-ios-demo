           ...
           failure:(void (^)(NSError *error))failure
{
    ...
    [_widget widgetUrl:^(NSString * _Nonnull widgetUrl) {
        ...
        // Use widget data from SDN Widget API v2 first
        ...
        if ([jitsiService isOpenIdJWTAuthenticationRequiredFor:jitsiWidgetData])
        {
            ...
            [jitsiService getOpenIdJWTTokenWithJitsiServerDomain:jitsiWidgetData.domain
                                                          roomId:roomId sdnSession:session success:^(NSString * _Nonnull jwtToken) {
                MXStrongifyAndReturnIfNil(self);
...
// Fill Jitsi data based on SDN Widget V2 widget data
...
// Extract data based on SDN Widget V1 URL
