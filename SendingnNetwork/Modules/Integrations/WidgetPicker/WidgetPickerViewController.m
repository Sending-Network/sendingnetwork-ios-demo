...
{
    MXKRoomDataSourceManager *roomDataSourceManager = [MXKRoomDataSourceManager sharedManagerForSDNSession:mxSession];
    [roomDataSourceManager roomDataSourceForRoom:roomId create:NO onComplete:^(MXKRoomDataSource *roomDataSource) {
        ...
        if (SendingnNetworkSettings.shared.roomInfoScreenShowIntegrations)
        {
