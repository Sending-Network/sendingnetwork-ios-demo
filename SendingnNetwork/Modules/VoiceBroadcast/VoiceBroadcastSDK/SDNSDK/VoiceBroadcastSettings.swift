...
final class VoiceBroadcastSettings: NSObject {
    static let voiceBroadcastInfoContentKeyType = "io.sendingnetwork.voice_broadcast_info"
    ...
    static let voiceBroadcastContentKeyChunkType = "io.sendingnetwork.voice_broadcast_chunk"
