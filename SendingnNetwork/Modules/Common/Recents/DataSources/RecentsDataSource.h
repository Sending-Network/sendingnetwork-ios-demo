...
/**
 'RecentsDataSource' class inherits from 'MXKInterleavedRecentsDataSource' to define the SendingnNetwork recents source
...
- (instancetype)initWithSDNSession:(MXSession*)mxSession NS_UNAVAILABLE;
