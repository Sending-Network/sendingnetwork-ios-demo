...
public class RecentsListService: NSObject, RecentsListServiceProtocol {
    ...
    private var showAllRoomsInHomeSpace: Bool {
        return SendingnNetworkSettings.shared.showAllRoomsInHomeSpace
    }
    ...
    private var sortOptions: MXRoomListDataSortOptions {
        switch mode {
        case .home:
            let pinMissed = SendingnNetworkSettings.shared.pinRoomsWithMissedNotificationsOnHome
            let pinUnread = SendingnNetworkSettings.shared.pinRoomsWithUnreadMessagesOnHome
    ...
    private init(withSession session: MXSession,
        ...
        super.init()
        createFetchers()
        addSendingnNetworkSettingsObserver()
    ...
    public func stop() {
        ...
        removeSendingnNetworkSettingsObserver()
        removeAllDelegates()
    ...
    //  MARK: - SendingnNetwork Settings Observer
    
    private func addSendingnNetworkSettingsObserver() {
    ...
    private func removeSendingnNetworkSettingsObserver() {
    ...
    private func userDefaultsUpdated(_ notification: Notification) {
        ...
        switch key {
        case SendingnNetworkSettings.UserDefaultsKeys.pinRoomsWithMissedNotificationsOnHome,
             SendingnNetworkSettings.UserDefaultsKeys.pinRoomsWithUnreadMessagesOnHome:
            refresh()
        case SendingnNetworkSettings.UserDefaultsKeys.showAllRoomsInHomeSpace:
            refresh()
        default:
            break
        }
