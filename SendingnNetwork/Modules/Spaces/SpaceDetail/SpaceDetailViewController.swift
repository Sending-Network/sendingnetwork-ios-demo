...
class SpaceDetailViewController: UIViewController {
    ...
    private func renderLoaded(parameters: SpaceDetailLoadedParameters) {
        ...
        let avatarViewData = AvatarViewData(sdnItemId: parameters.spaceId,
                                            displayName: parameters.displayName,
                                            avatarUrl: parameters.avatarUrl,
                                            mediaManager: self.mediaManager,
                                            fallbackImage: .sdnItem(parameters.spaceId, parameters.displayName))
        ...
        if let inviterId = parameters.inviterId {
            ...
            if let inviter = parameters.inviter {
                let avatarViewData = AvatarViewData(sdnItemId: inviter.userId, displayName: inviter.displayname, avatarUrl: inviter.avatarUrl, mediaManager: self.mediaManager, fallbackImage: .sdnItem(inviter.userId, inviter.displayname))
