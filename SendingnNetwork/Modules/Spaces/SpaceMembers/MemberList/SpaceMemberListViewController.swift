...
final class SpaceMemberListViewController: RoomParticipantsViewController {
    ...
    override func roomMemberDetailsViewController(_ roomMemberDetailsViewController: MXKRoomMemberDetailsViewController!, startChatWithMemberId sdnId: String!, completion: (() -> Void)!) {
        completion()
    ...
    override func roomMemberDetailsViewController(_ roomMemberDetailsViewController: MXKRoomMemberDetailsViewController!, placeVoipCallWithMemberId sdnId: String!, andVideo isVideoCall: Bool) {
        self.errorPresenter.presentError(from: self, title: VectorL10n.spacesComingSoonTitle, message: VectorL10n.spacesComingSoonDetail(AppInfo.current.displayName), animated: true, handler: nil)
    }
}
