 ...
 */
- (void)displayUsersDevices:(MXUsersDevicesMap<MXDeviceInfo*>*)usersDevices andSDNSession:(MXSession*)mxSession onComplete:(void (^)(BOOL doneButtonPressed))onComplete;
