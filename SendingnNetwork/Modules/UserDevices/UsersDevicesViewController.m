...
- (void)displayUsersDevices:(MXUsersDevicesMap<MXDeviceInfo*>*)theUsersDevices andSDNSession:(MXSession*)sdnSession onComplete:(void (^)(BOOL doneButtonPressed))onComplete
{
