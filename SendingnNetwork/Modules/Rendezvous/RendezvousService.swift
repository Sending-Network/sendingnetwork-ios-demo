...
enum RendezvousChannelAlgorithm: String {
    case ECDH_V1 = "org.sdn.msc3903.rendezvous.v1.curve25519-aes-sha256"
    case ECDH_V2 = "org.sdn.msc3903.rendezvous.v2.curve25519-aes-sha256"
}

/// Algorithm name as per MSC3906
enum RendezvousFlow: String {
    /// The v1 value never actually appears in JSON
    case SETUP_ADDITIONAL_DEVICE_V1 = "org.sdn.msc3906.v1"
    case SETUP_ADDITIONAL_DEVICE_V2 = "org.sdn.msc3906.setup.additional_device.v2"
}
    ...
    func createRendezvous() async -> Result<RendezvousDetails, RendezvousServiceError> {
        ...
        case .success:
            ...
            let fullDetails = RendezvousDetails(algorithm: algorithm.rawValue,
                                                transport: RendezvousTransportDetails(type: "org.sdn.msc3886.http.v1",
