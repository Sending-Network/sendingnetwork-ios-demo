...
- (void)updateSections
{
    ...
    if (SendingnNetworkSettings.shared.settingsScreenShowChangePassword)
    {
    ...
    if (SendingnNetworkSettings.shared.enableNewSessionManager)
    {
    ...
    if (SendingnNetworkSettings.shared.settingsScreenShowNotificationDecodedContentOption)
    {
    ...
    if (BuildSettings.allowVoIPUsage && BuildSettings.stunServerFallbackUrlString && SendingnNetworkSettings.shared.settingsScreenShowEnableStunServerFallback)
    {
    ...
    if (SendingnNetworkSettings.shared.sdnApps)
    {
    ...
    if (SendingnNetworkSettings.shared.settingsScreenShowNsfwRoomsOption)
    {
...
- (void)viewDidLoad
{
    ...
    // Add each sdn session, to update the view controller appearance according to mx sessions state
...
- (void)onSDNSessionStateDidChange:(NSNotification *)notif
{
    ...
    {
        [super onSDNSessionStateDidChange:notif];
    }
}
...
//    NSString *nodeInfo = [VectorL10n settingsConfigNode:account.mxCredentials.node];
    
    NSString *sdkVersionInfo = [NSString stringWithFormat:@"SDN SDK %@", SDNSDKVersion];
                                             ...
                                             atIndexPath:(NSIndexPath*)indexPath
{
    ...
    labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.roomScreenEnableMessageBubbles;
                                             ...
                                             atIndexPath:(NSIndexPath*)indexPath
{
    ...
    labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableUISIAutoReporting;
    labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
    labelAndSwitchCell.mxkSwitch.enabled = YES;
                                                  ...
                                                  atIndexPath:(NSIndexPath*)indexPath
{
    ...
    labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableLiveLocationSharing;
    labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
    labelAndSwitchCell.mxkSwitch.enabled = YES;
...
- (void)showAuthenticationIfNeededForAdding:(MX3PIDMedium)medium withSession:(MXSession*)session completion:(void (^)(NSDictionary* authParams))completion
{
    ...
    [session.sdnRestClient add3PIDOnlyWithSessionId:@"" clientSecret:[MXTools generateSecret] authParams:nil success:^{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (section == SECTION_TAG_SIGN_OUT)
    {
        ...
        {
            // Fix https://github.com/Sending-Network/SendingnNetwork-ios/issues/1354
            // Do not move this line in prepareForReuse because of https://github.com/Sending-Network/SendingnNetwork-ios/issues/1323
    ...
    else if (section == SECTION_TAG_USER_SETTINGS)
    {
        ...
        if (row == USER_SETTINGS_PROFILE_PICTURE_INDEX)
        {
            ...
            {
                UIImage* avatarImage = [AvatarGenerator generateAvatarForSDNItem:myUser.userId withDisplayName:myUser.displayname];
    ...
    else if (section == SECTION_TAG_SENDING_MEDIA)
    {
        if (row == SENDING_MEDIA_CONFIRM_SIZE)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on =  SendingnNetworkSettings.shared.showMediaCompressionPrompt;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
    ...
    else if (section == SECTION_TAG_LINKS)
    {
        if (row == LINKS_SHOW_URL_PREVIEWS_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.roomScreenShowsURLPreviews;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
    ...
    else if (section == SECTION_TAG_NOTIFICATIONS)
    {
        ...
        else if (row == NOTIFICATION_SETTINGS_SHOW_IN_APP_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.showInAppNotifications;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
        ...
        else if (row == NOTIFICATION_SETTINGS_SHOW_DECODED_CONTENT)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.showDecryptedContentInNotifications;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = account.pushNotificationServiceIsActive;
        ...
        else if (row == NOTIFICATION_SETTINGS_PIN_MISSED_NOTIFICATIONS_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.pinRoomsWithMissedNotificationsOnHome;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
        ...
        else if (row == NOTIFICATION_SETTINGS_PIN_UNREAD_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.pinRoomsWithUnreadMessagesOnHome;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
    ...
    else if (section == SECTION_TAG_CALLS)
    {
        if (row == CALLS_ENABLE_STUN_SERVER_FALLBACK_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.allowStunServerFallback;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
    ...
    else if (section == SECTION_TAG_INTEGRATIONS)
    {
        switch (row) {
            ...
            {
                SendingnNetworkSharedSettings *sharedSettings = [[SendingnNetworkSharedSettings alloc] initWithSession:session];
    ...
    else if (section == SECTION_TAG_USER_INTERFACE)
    {
        ...
        else if (row == USER_INTERFACE_THEME_INDEX)
        {
            ...
            NSString *theme = SendingnNetworkSettings.shared.userInterfaceTheme;
    ...
    else if (section == SECTION_TAG_TIMELINE)
    {
        ...
        else if (row == TIMELINE_USE_ONLY_LATEST_USER_AVATAR_AND_NAME_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.roomScreenUseOnlyLatestUserAvatarAndName;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
    ...
    else if (section == SECTION_TAG_ADVANCED)
    {
        if (row == ADVANCED_SHOW_NSFW_ROOMS_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.showNSFWPublicRooms;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
        ...
        else if (row == ADVANCED_CRASH_REPORT_INDEX)
        {
            ...
            sendCrashReportCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableAnalytics;
        ...
        else if (row == ADVANCED_ENABLE_RAGESHAKE_INDEX)
        {
            ...
            enableRageShakeCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableRageShake;
    ...
    else if (section == SECTION_TAG_LABS)
    {
        if (row == LABS_ENABLE_RINGING_FOR_GROUP_CALLS_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableRingingForGroupCalls;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
        ...
        else if (row == LABS_ENABLE_THREADS_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableThreads;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
        ...
        else if (row == LABS_ENABLE_NEW_SESSION_MANAGER)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableNewSessionManager;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
        ...
        else if (row == LABS_ENABLE_NEW_CLIENT_INFO_FEATURE)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableClientInformationFeature;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
        ...
        else if (row == LABS_ENABLE_WYSIWYG_COMPOSER)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableWysiwygComposer;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
        ...
        else if (row == LABS_ENABLE_VOICE_BROADCAST)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = SendingnNetworkSettings.shared.enableVoiceBroadcast;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
    ...
    if (self.tableView == tableView)
    {
        ...
        else if (section == SECTION_TAG_SECURITY)
        {
            switch (row)
            {
                case SECURITY_BUTTON_INDEX:
                {
                    SecurityViewController *securityViewController = [SecurityViewController instantiateWithSDNSession:self.mainSession];
            ...
            [removePrompt addAction:[UIAlertAction actionWithTitle:[VectorL10n remove]
                                                           ...
                                                           handler:^(UIAlertAction * action) {
                                                               ...
                                                               if (weakSelf)
                                                               {
                                                                   ...
                                                                   [self.mainSession.sdnRestClient remove3PID:address medium:medium success:^{
...
{
    SendingnNetworkSettings.shared.showMediaCompressionPrompt = sender.on;
}
...
{
    SendingnNetworkSettings.shared.showInAppNotifications = sender.isOn;
}
...
{
    SendingnNetworkSettings.shared.allowStunServerFallback = sender.isOn;

    self.mainSession.callManager.fallbackSTUNServer = SendingnNetworkSettings.shared.allowStunServerFallback ? BuildSettings.stunServerFallbackUrlString : nil;
}
...
{
    SendingnNetworkSettings.shared.showDecryptedContentInNotifications = sender.isOn;
}
...
{
    SendingnNetworkSettings.shared.roomScreenShowsURLPreviews = sender.on;
    
    // Any loaded cell data is now invalid and should be refreshed for the new value.
    [[MXKRoomDataSourceManager sharedManagerForSDNSession:self.mainSession] reset];
}
...
{
    SendingnNetworkSettings.shared.enableRageShake = sender.isOn;
...
{
    SendingnNetworkSettings.shared.enableRingingForGroupCalls = sender.isOn;
}

- (void)toggleEnableThreads:(UISwitch *)sender
{
    if (sender.isOn && !self.mainSession.store.supportedSDNVersions.supportsThreads)
    {
...
{
    SendingnNetworkSettings.shared.enableThreads = enable;
...
{
    SendingnNetworkSettings.shared.enableNewSessionManager = sender.isOn;
    [self updateSections];
}
...
- (void)toggleEnableNewClientInfoFeature:(UISwitch *)sender
{
    ...
    SendingnNetworkSettings.shared.enableClientInformationFeature = isEnabled;
...
{
    SendingnNetworkSettings.shared.enableWysiwygComposer = sender.isOn;
}

- (void)toggleEnableVoiceBroadcastFeature:(UISwitch *)sender
{
    SendingnNetworkSettings.shared.enableVoiceBroadcast = sender.isOn;
}

- (void)togglePinRoomsWithMissedNotif:(UISwitch *)sender
{
    SendingnNetworkSettings.shared.pinRoomsWithMissedNotificationsOnHome = sender.isOn;
}

- (void)togglePinRoomsWithUnread:(UISwitch *)sender
{
    SendingnNetworkSettings.shared.pinRoomsWithUnreadMessagesOnHome = sender.on;
}

- (void)toggleUseOnlyLatestUserAvatarAndName:(UISwitch *)sender
{
    SendingnNetworkSettings.shared.roomScreenUseOnlyLatestUserAvatarAndName = sender.isOn;
}
...
- (void)onSave:(id)sender
{
    ...
    if (newAvatarImage)
    {
        ...
        // Upload picture
        MXMediaLoader *uploader = [MXMediaManager prepareUploaderWithSDNSession:account.mxSession initialRange:0 andRange:1.0];
...
- (IBAction)onAddNewPhone:(id)sender
{
    ...
    if (![[NBPhoneNumberUtil sharedInstance] isValidNumber:newPhoneNumber])
    {
        ...
        UIAlertController *errorAlert = [UIAlertController alertControllerWithTitle:[VectorL10n accountErrorMsisdnWrongTitle]
                                                                     ...
                                                                     preferredStyle:UIAlertControllerStyleAlert];
//        [VectorL10n accountErrorMsisdnWrongDescription];
...
- (void)showThemePicker
{
    ...
    void (^actionBlock)(UIAlertAction *action) = ^(UIAlertAction * action) {
        ...
        if (weakSelf)
        {
            ...
            {
                // Clear fake SendingnNetwork Avatars based on the previous theme.
                [AvatarGenerator clear];

                // The user wants to select this theme
                SendingnNetworkSettings.shared.userInterfaceTheme = newTheme;
...
{
    DeactivateAccountViewController *deactivateAccountViewController = [DeactivateAccountViewController instantiateWithSDNSession:self.mainSession];
    
    UINavigationController *navigationController = [[SendingnNetworkNavigationController alloc] initWithRootViewController:deactivateAccountViewController];
...
{
    SendingnNetworkSettings.shared.showNSFWPublicRooms = sender.isOn;
}

- (void)toggleEnableRoomMessageBubbles:(UISwitch *)sender
{
    SendingnNetworkSettings.shared.roomScreenEnableMessageBubbles = sender.isOn;
            
    [[RoomTimelineConfiguration shared] updateStyleWithIdentifier:SendingnNetworkSettings.shared.roomTimelineStyleIdentifier];
    
    // Close all room data sources
    // Be sure to use new room timeline style configurations
    MXKRoomDataSourceManager *roomDataSourceManager = [MXKRoomDataSourceManager sharedManagerForSDNSession:self.mainSession];
...
{
    SendingnNetworkSettings.shared.enableUISIAutoReporting = sender.isOn;
}

- (void)toggleEnableLiveLocationSharing:(UISwitch *)sender
{
    SendingnNetworkSettings.shared.enableLiveLocationSharing = sender.isOn;
}
...
- (void)languagePickerViewController:(MXKLanguagePickerViewController *)languagePickerViewController didSelectLangugage:(NSString *)language
{
        ...
        || (language == nil && [NSBundle mxk_language]))
    {
        ...
        // Note that "reloadSDNSessions:NO" will reset room summaries
        [self startActivityIndicator];
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, 0.3 * NSEC_PER_SEC), dispatch_get_main_queue(), ^{

            [[AppDelegate theDelegate] reloadSDNSessions:NO];
        });
    }
}
                       ...
                       checkingAccessForContactsOnAccept:(BOOL)checkAccessForContacts
{
    ...
    [session prepareIdentityServiceForTermsWithDefault:SendingnNetworkSettings.shared.identityServerUrlString
