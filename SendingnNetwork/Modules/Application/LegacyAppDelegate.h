...
// Remove a sdn session.
- (void)removeSDNSession:(MXSession*)mxSession;

// Mark all messages as read in the running sdn sessions.
...
/**
 ...
 @param sendLogoutServerRequest Indicate whether send logout request to node.
 @param completion the block to execute at the end of the operation.
 */
...
- (void)legacyAppDelegate:(LegacyAppDelegate*)legacyAppDelegate didAddSDNSession:(MXSession*)session;

- (void)legacyAppDelegate:(LegacyAppDelegate*)legacyAppDelegate didRemoveSDNSession:(MXSession*)session;
