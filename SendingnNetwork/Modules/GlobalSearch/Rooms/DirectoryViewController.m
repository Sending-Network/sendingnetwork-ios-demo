...
- (void)showRoomWithId:(NSString*)roomId inSDNSession:(MXSession*)mxSession
{
...
- (void)refreshCurrentSelectedCell:(BOOL)forceVisible
{
    ...
    if (masterTabBarController.selectedRoomId)
    {
        ...
        currentSelectedCellIndexPath = [dataSource cellIndexPathWithRoomId:masterTabBarController.selectedRoomId andSDNSession:masterTabBarController.selectedRoomSession];
    }
...
- (void)showRoomWithPublicRoom:(MXPublicRoom*)publicRoom
{
    ...
    if ([dataSource.mxSession isJoinedOnRoom:publicRoom.roomId])
    {
        ...
        [self showRoomWithId:publicRoom.roomId inSDNSession:dataSource.mxSession];
    }
    else
    {
