...
- (void)viewDidLoad
{
    ...
    // Initialize here the data sources if a sdn session has been already set.
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    // TODO: Notify SendingnNetworkSettings.shared.showNSFWPublicRooms change for iPad as viewWillAppear may not be called
    recentsDataSource.publicRoomsDirectoryDataSource.showNSFWRooms = SendingnNetworkSettings.shared.showNSFWPublicRooms;
...
- (void)initializeDataSources
{
    ...
    if (mainSession)
    {
        ...
        recentsDataSource = [[UnifiedSearchRecentsDataSource alloc] initWithSDNSession:mainSession
                             recentsListService:recentsListService];
        [recentsViewController displayList:recentsDataSource];
        
        // Init the search for messages
        messagesSearchDataSource = [[HomeMessagesSearchDataSource alloc] initWithSDNSession:mainSession];
        [messagesSearchViewController displaySearch:messagesSearchDataSource];
        
        // Init the search for messages
        filesSearchDataSource = [[MXKSearchDataSource alloc] initWithSDNSession:mainSession];
        ...
        peopleSearchDataSource = [[ContactsDataSource alloc] initWithSDNSession:mainSession];
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    {
        // As the messages/files search is done node-side, launch it only on the "Search" button
        [self updateSearch];
    }
}
