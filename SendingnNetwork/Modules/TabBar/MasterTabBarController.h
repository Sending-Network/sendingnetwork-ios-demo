...
// Add a sdn session. This session is propagated to all view controllers handled by the tab bar controller.
...
/// @param mxSession The sdn session in which the room filtering should be done.
