 ...
 */
extern NSString *const kMXKRoomBubbleCellSendingnNetworkEditButtonPressed;
...
/**
 Define a `MXKRoomBubbleTableViewCell` category at SendingnNetwork level to handle bubble customisation.
 */
@interface MXKRoomBubbleTableViewCell (SendingnNetwork)
