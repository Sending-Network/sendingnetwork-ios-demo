...
NSString *const kMXKRoomBubbleCellSendingnNetworkEditButtonPressed = @"kMXKRoomBubbleCellSendingnNetworkEditButtonPressed";
...
@implementation MXKRoomBubbleTableViewCell (SendingnNetwork)
                             ...
                             displayOnLeft:(BOOL)displayOnLeft
{
    ...
    {
        MXLogDebug(@"[MXKRoomBubbleTableViewCell+SendingnNetwork] bubbleInfoContainer property is missing for cell class: %@", NSStringFromClass(self.class));
        return;
    }
...
- (IBAction)onEditButtonPressed:(id)sender
{
    if (self.delegate)
    {
        ...
        if (selectedEvent)
        {
            [self.delegate cell:self didRecognizeAction:kMXKRoomBubbleCellSendingnNetworkEditButtonPressed userInfo:@{kMXKRoomBubbleCellEventKey:selectedEvent}];
        }
    }
}
