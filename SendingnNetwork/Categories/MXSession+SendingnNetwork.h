...
#import <SDNSDK/MXSession.h>

@class NodeConfiguration;

@interface MXSession (SendingnNetwork)
...
/**
Return the node configuration based on HS Well-Known or BuildSettings properties according to existing values.
*/
- (NodeConfiguration*)vc_nodeConfiguration;

/**
 SendingnNetwork version of [MXSession canEnableE2EByDefaultInNewRoomWithUsers:]
 */
