...
class MediaCompressionHelper: NSObject {
    ...
    /// and the `showMediaCompressionPrompt` SendingnNetwork setting.
    @objc static var defaultCompressionMode: MXKRoomInputToolbarCompressionMode {
        ...
        if BuildSettings.roomInputToolbarCompressionMode == .prompt {
            return SendingnNetworkSettings.shared.showMediaCompressionPrompt ? MXKRoomInputToolbarCompressionModePrompt : MXKRoomInputToolbarCompressionModeNone
        } else {
