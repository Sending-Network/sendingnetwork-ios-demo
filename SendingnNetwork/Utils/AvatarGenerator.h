...
/**
 Generate a squared avatar for a sdn item (room, room member...).
 @param itemId the sdn identifier of the item
 @param displayname the item displayname (if nil, the itemId is used by default).
 @return the avatar image
 */
+ (UIImage*)generateAvatarForSDNItem:(NSString*)itemId withDisplayName:(NSString*)displayname;

/**
 Generate a squared avatar for a sdn item (room, room member...) with a preferred size
 @param itemId the sdn identifier of the item
 @param displayname the item displayname (if nil, the itemId is used by default).
 ...
 @return the avatar image
 */
+ (UIImage*)generateAvatarForSDNItem:(NSString*)itemId withDisplayName:(NSString*)displayname size:(CGFloat)size andFontSize:(CGFloat)fontSize;
