...
/// Shared user settings across all SendingnNetwork clients.
/// It implements https://github.com/Sending-Network/SendingnNetwork-meta/blob/master/spec/settings.md
@objcMembers
class SendingnNetworkSharedSettings: NSObject {

    // MARK: - Constants
    private enum Settings {
        static let breadcrumbs = "im.vectSending.setting.breadcrumbs"
        static let integrationProvisioning = "im.vectSending.setting.integration_provisioning"
        static let allowedWidgets = "im.vectSending.setting.allowed_widgets"
    }
    ...
    func getIntegrationProvisioning() -> SendingnNetworkSettingIntegrationProvisioning? {
    ...
    func setIntegrationProvisioning(enabled: Bool,
        ...
        integrationProvisioningDict[SendingnNetworkSettingIntegrationProvisioning.CodingKeys.enabled.rawValue] = enabled
    ...
    func getAllowedWidgets() -> SendingnNetworkSettingAllowedWidgets? {
    ...
    func setPermission(_ permission: WidgetPermission,
        ...
        allowedWidgetsDict[SendingnNetworkSettingAllowedWidgets.CodingKeys.widgets.rawValue] = widgets
    ...
    func setPermission(_ permission: WidgetPermission,
        ...
        var allowedWidgetsDict = getAccountData(forEventType: Settings.allowedWidgets) ?? [:]
        allowedWidgetsDict[SendingnNetworkSettingAllowedWidgets.CodingKeys.nativeWidgets.rawValue] = nativeWidgets
