...
/**
 The type of sdn event used for sdn widgets.
 */
FOUNDATION_EXPORT NSString *const kWidgetSDNEventTypeString;

/**
 The type of sdn event used for modular widgets.
 TODO: It should be replaced by kWidgetSDNEventTypeString.
 */
