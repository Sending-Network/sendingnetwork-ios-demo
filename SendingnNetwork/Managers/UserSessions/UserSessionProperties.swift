...
class UserSessionProperties: NSObject {
    ...
    private var dictionary: [String: Any] {
        get {
            SendingnNetworkSettings.shared.userSessionProperties[userId] ?? [:]
        }
        set {
            var sharedProperties = SendingnNetworkSettings.shared.userSessionProperties
            sharedProperties[userId] = newValue
            SendingnNetworkSettings.shared.userSessionProperties = sharedProperties
        }
    }
