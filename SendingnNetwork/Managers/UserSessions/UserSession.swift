...
/// UserSession represents a SDN user session
/// Note: UserSessionProtocol can be renamed UserSession and UserSession -> SDNUserSession if we keep this abstraction.
@objcMembers
class UserSession: NSObject, UserSessionProtocol {
    ...
    init(account: MXKAccount, sdnSession: MXSession) {
