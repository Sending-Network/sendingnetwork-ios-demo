...
extension VectorWellKnown: Decodable {
    ...
    enum CodingKeys: String, CodingKey {
        case encryption = "io.sendingnetwork.e2ee"
        case jitsi = "io.sendingnetwork.jitsi"
        // Deprecated keys
        case deprecatedEncryption = "im.vectSending.SendingnNetwork.e2ee"
        case deprecatedJitsi = "im.vectSending.SendingnNetwork.jitsi"
    }
}
